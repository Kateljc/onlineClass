<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolWorkPublish.aspx.cs" Inherits="SchoolWorkPublish" %>
...
<body style="font-size: 12pt; text-align: center;">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label" runat="server" Style="z-index: 115; left: 798px; position: absolute;
            top: 471px"></asp:Label>
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Teacher.aspx" Style="z-index: 117;
