<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MsgBoard.aspx.cs" Inherits="MsgBoard" %>
...
<body style="text-align: center">
 ...
 <span style="font-size: 32pt; font-family: 楷体_GB2312"> 发表新主题<br />
            <span style="font-size: 11pt">请输入您的姓名：&nbsp; &nbsp;<asp:TextBox ID="tbName" runat="server"></asp:TextBox>
                ...
                <br />
                <asp:HyperLink ID="HyperLink1" runat="server" Height="18px" NavigateUrl="~/Default.aspx"
