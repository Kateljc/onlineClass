...
public partial class SchoolWorkStudent : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //
        dbCommand.CommandText = "INSERT INTO SchoolWorkSubmit2(SWSubmitID,SWSubmitName,SWSubmitTitle,SWSubmitContent,SWSubmitDate,TeacherComment) VALUES('";
        dbCommand.CommandText += strTitle + "','" + strContent + "','" + strDate + "','" + strComment + "');";
        dbCommand.ExecuteNonQuery();
        dbConnection.Close();
        dbConnection.Dispose();
        Response.Redirect("SchoolWorkStudent2.aspx");
    }
}
