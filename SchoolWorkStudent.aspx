<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolWorkStudent.aspx.cs" Inherits="SchoolWorkStudent" %>
   ...
   <span style="font-size: 32pt; font-family: 楷体_GB2312"> <span style="font-size: 24pt;
       ...
       作业提交</span><br />
            <span style="font-size: 11pt"><br />
                ...
                <br />
                <asp:HyperLink ID="HyperLink1" runat="server" Height="4px" NavigateUrl="~/Student.aspx"
